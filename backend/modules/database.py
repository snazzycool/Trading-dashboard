"""
modules/database.py — SQLite persistence layer v2.
Updated schema supports score out of 10 and pip fields.
"""
import sqlite3
import logging
import json
...
def _connect() -> sqlite3.Connection:
    ...
    # Safe migration: add new columns if upgrading from v1 schema
    for col, typedef in [
        ("pip_risk",   "REAL NOT NULL DEFAULT 0"),
        ("pip_reward", "REAL NOT NULL DEFAULT 0"),
    ]:
